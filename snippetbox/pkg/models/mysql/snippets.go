...
func (m *SnippetModel) InsertSessionID(sessionIDcol string) (int, error) {
	...
	stmt := `INSERT INTO snippetbox.sessionid (sessionIDcol, date) 
	...
	result, err := m.DB.Exec(stmt, sessionIDcol)
	if err != nil {
		return 0, err
	}
